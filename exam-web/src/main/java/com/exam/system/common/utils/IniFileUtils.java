...
public class IniFileUtils {
     ...
     */
    public IniFileUtils(File file) throws FileNotFoundException {
     ...
     * @throws FileNotFoundException
     */
    public IniFileUtils(String path) throws FileNotFoundException {
     ...
     * @throws IOException
     */
    public IniFileUtils(ClassPathResource source) throws IOException {
        this(source.getFile());
    }
