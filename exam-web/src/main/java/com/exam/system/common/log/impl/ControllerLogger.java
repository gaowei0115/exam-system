 ...
 */
public class ControllerLogger extends ExamBaseLogger{

    /**
     * logger
     */
    private static final Logger log = LoggerFactory.getLogger(LoggerType.CONTROLL_LOGGER_TYPE);

    public ControllerLogger(Logger log) {
        super(log);
    }

    public ControllerLogger(Class<?> clazz, String businessName) {
